...
#
# Generated by export_simulation on Tue Dec 27 16:11:30 +0800 2016
#
################################################################################
...
switch to the './bg_mid.sh' script.
...
./bg_mid.sh -noclean_files

For more information on the script, please type './bg_mid.sh -help'.

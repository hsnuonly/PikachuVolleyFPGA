...
#
# Generated by export_simulation on Fri Dec 23 20:36:25 +0800 2016
#
################################################################################
...
switch to the './pikachu_down_pixel.sh' script.

./pikachu_down_pixel.sh -reset_run
...
./pikachu_down_pixel.sh -noclean_files

For more information on the script, please type './pikachu_down_pixel.sh -help'.

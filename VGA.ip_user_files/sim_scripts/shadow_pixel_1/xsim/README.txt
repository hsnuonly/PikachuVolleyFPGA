...
#
# Generated by export_simulation on Fri Dec 23 11:47:31 +0800 2016
#
################################################################################
...
switch to the './shadow_pixel.sh' script.

./shadow_pixel.sh -reset_run
...
./shadow_pixel.sh -noclean_files

For more information on the script, please type './shadow_pixel.sh -help'.

...
#
# Generated by Vivado on Wed Dec 28 13:21:13 +0800 2016
...
# Script info
echo -e "num.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot num xil_defaultlib.num xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim num -key {Behavioral:sim_1:Functional:num} -tclbatch cmd.tcl -log simulate.log
}

...
#
# Generated by export_simulation on Fri Dec 23 00:53:04 +0800 2016
#
################################################################################
...
switch to the './ball_pixel.sh' script.

./ball_pixel.sh -reset_run
...
./ball_pixel.sh -noclean_files

For more information on the script, please type './ball_pixel.sh -help'.

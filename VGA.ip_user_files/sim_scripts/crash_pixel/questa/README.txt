...
#
# Generated by export_simulation on Fri Dec 30 13:47:28 +0800 2016
#
################################################################################
...
switch to the './crash_pixel.sh' script.

./crash_pixel.sh -reset_run
...
./crash_pixel.sh -noclean_files

For more information on the script, please type './crash_pixel.sh -help'.

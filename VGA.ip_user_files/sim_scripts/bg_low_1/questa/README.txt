...
#
# Generated by export_simulation on Tue Dec 27 16:25:30 +0800 2016
#
################################################################################
...
switch to the './bg_low.sh' script.
...
./bg_low.sh -noclean_files

For more information on the script, please type './bg_low.sh -help'.

...
#
# Generated by export_simulation on Fri Dec 23 00:53:54 +0800 2016
#
################################################################################
...
switch to the './pikachu_pixel.sh' script.

./pikachu_pixel.sh -reset_run
...
./pikachu_pixel.sh -noclean_files

For more information on the script, please type './pikachu_pixel.sh -help'.
